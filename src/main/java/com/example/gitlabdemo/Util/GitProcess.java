...
//            System.out.println(user);
    ...
    public GitProject setTeacherInfo(GitProject gitProject, Integer teacher_id){
        try{
            RepositoryFile repositoryFile = gitLabApi.getRepositoryFileApi().getFile(teacher_id, "task_config", "master");
...
//                throw new Exception("fail exist");
    ...
    public boolean gitcreateFile(Integer projectId, GitFile gitFile){
        try {
            ...
            System.out.println(Base64Convert.baseConvertStr(gitFile.getShortid()));
